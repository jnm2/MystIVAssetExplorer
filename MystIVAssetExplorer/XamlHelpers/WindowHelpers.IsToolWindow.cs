...
public static partial class WindowHelpers
{
    ...
    private static void OnIsToolWindowPropertyChanged(AvaloniaPropertyChangedEventArgs<bool> args)
    {
        ...
        window.Opened += (_, _) =>
        {
            ...
            if (SetWindowLongW(handle, GWL_EXSTYLE, exStyle) == 0) throw new Win32Exception();
        };
    }
